          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-slate-50 rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="strategy-tag" className="text-xs font-medium text-slate-600">
                    Strategy Tag
                  </Label>
                  <div className="relative">
                    <Select value={strategyTag} onValueChange={setStrategyTag}>
                      <SelectTrigger id="strategy-tag" className="h-9 bg-white border-slate-200 shadow-sm pr-10">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="absolute right-0 top-0 h-9 w-9 p-0 hover:bg-blue-50"
                  ...
                  {showTagInput && (
                    <div className="mt-2 flex gap-2">
                      ...
                      />
                      <Button size="sm" className="h-8 bg-blue-600 hover:bg-blue-700" onClick={addStrategyTag}>
                        Add
                      </Button>
              ...
              {isAdvanced && (
                <div className="space-y-4 pt-2 border-t border-slate-100">
                  <div className="space-y-4 pt-4 border-t border-slate-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-red-50 rounded-md">
                      <div className="space-y-2">
                        <Label htmlFor="sl-premium" className="text-xs font-medium text-slate-600">
                          Combined Premium (%)
                        </Label>
                        <Input
                          id="sl-premium"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="sl-value" className="text-xs font-medium text-slate-600">
                          Combined Value (₹)
                        </Label>
                        <Input
                          id="sl-value"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-green-50 rounded-md">
                      <div className="space-y-2">
                        <Label htmlFor="target-premium" className="text-xs font-medium text-slate-600">
                          Combined Premium (%)
                        </Label>
                        <Input
                          id="target-premium"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="target-value" className="text-xs font-medium text-slate-600">
                          Combined Value (₹)
                        </Label>
                        <Input
                          id="target-value"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 p-4 bg-purple-50 rounded-md">
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <label htmlFor="sqoffLossMaking" className="text-sm text-red-600 font-medium">
                          Loss Making
                        </label>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <label htmlFor="sqoffProfitMaking" className="text-sm text-green-600 font-medium">
                          Profit Making
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="validity" className="text-xs font-medium text-slate-600">
                        Order Validity
                      </Label>
                      <Select defaultValue="day">
                        <SelectTrigger id="validity" className="h-9 bg-white border-slate-200 shadow-sm">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="qty-by-exposure" className="text-xs font-medium text-slate-600">
                        Qty by Exposure
                      </Label>
                      <Input
                        id="qty-by-exposure"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="max-lots" className="text-xs font-medium text-slate-600">
                        Max Lots
                      </Label>
                      <Input
                        id="max-lots"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="portfolio-execution-mode" className="text-xs font-medium text-slate-600">
                      Portfolio Execution Mode
                    </Label>
                    <Select defaultValue="StartTime">
                      <SelectTrigger id="portfolio-execution-mode" className="h-9 bg-white border-slate-200 shadow-sm">
                        <SelectValue placeholder="Select execution mode" />
                      </SelectTrigger>
                      <SelectContent>
